...
class SpotDetailViewController: UIViewController {
    ...
    let regionDistance: CLLocationDistance = 750 //750 meters/about half a mile
    ...
    override func viewDidLoad() {
        ...
        if spot == nil {
            ...
            saveBarButton.title = "" //Hides button
            cancelBarButton.title = "" //Hides button
    ...
    @IBAction func photoButtonPressed(_ sender: UIButton) {
        if spot.documentID == "" {
            saveCancelAlert(title: "This Venue Has Not Been Saved", message: "You must save this vanue before you can add a photo it.", segueIdentifier: "AddPhoto")
        } else {
    ...
    @IBAction func reviewButtonPressed(_ sender: UIButton) {
        if spot.documentID == "" {
            saveCancelAlert(title: "This Venue Has Not Been Saved", message: "You must save this vanue before you can review it.", segueIdentifier: "AddReview")
        } else {
